...
public class UserUiSet {
	...
	public UserUiSet(SessionVo session, Map<String, Object> parameters) throws Exception {
		...
		try {
			...
			tran.deleteOfClass(FX_UI_PROPERTY.class, null, deletePara);
			tran.deleteOfClass(FX_UI_BASIC.class, null, deletePara);
			tran.deleteOfClass(FX_UI_GROUP.class, null, deletePara);

			tran.insertOfClass(FX_UI_GROUP.class, uiGroup);
