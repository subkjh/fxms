	...
	public Object set(SessionVo session, Map<String, Object> parameters) throws Exception {
		...
		try {
			...
			if (main.getDiagNo() == null || main.getDiagNo() <= 0) {
				...
				tran.insertOfClass(FX_DI_MAIN.class, main);

			} else {
				Map<String, Object> deletePara = new HashMap<String, Object>();
				deletePara.put("diagNo", main.getDiagNo());
				tran.updateOfClass(FX_DI_MAIN.class, main, null);
				tran.deleteOfClass(FX_DI_NODE.class, null, deletePara);
				tran.deleteOfClass(FX_DI_LINE.class, null, deletePara);
				tran.deleteOfClass(FX_DI_PROPERTY.class, null, deletePara);
			}
