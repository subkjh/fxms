...
@FxIndex(name = "FY_UI_PROPERTY__PK", type = INDEX_TYPE.PK, columns = {"USER_NO", "UI_GROUP_NO", "UI_NO", "PROPERTY_NAME"})
public class FX_UI_PROPERTY implements Serializable {
