...
public class Alarm extends FxEvent implements Moable, MoOwnership, AlarmTag {
	...
	public Alarm(OccurAlarmDbo a) {

		this.alarmKey = a.getAlarmKey();
		this.alarmNo = a.getAlarmNo();
		this.alcdNo = a.getAlcdNo();
		this.moName = a.getMoName();
		this.moNo = a.getMoNo();
		this.moInstance = a.getMoInstance();
		this.upperMoNo = a.getUpperMoNo();
		this.upperMoName = a.getUpperMoName();
		this.alarmLevel = a.getAlarmLevel();
		this.ocuDate = a.getOcuDate();
		this.inloNo = a.getInloNo();
