...
public class SendMail {
	...
	private Logger logger = Logger.createLogger(Logger.logger.getFolder(), FxCfg.getFxServiceName() + "-mail");
	...
	public boolean sendmail(String to, String subject, String text) {
		...
		try {
			...
			Logger.logger.fail("from={},to={},subject={},result=error", from, to, subject);
			logger.debug(text);
			return false;
		}
	}
