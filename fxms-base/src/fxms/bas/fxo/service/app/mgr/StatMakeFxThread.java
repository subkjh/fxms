package fxms.bas.fxo.service.app.mgr;
...
import fxms.bas.fxo.service.app.dbo.StatMakeReqDbo;
import fxms.bas.fxo.service.app.dbo.StatMakeReqHstDbo;
...
public class StatMakeFxThread extends CycleFxThread {
	...
	class StatDao extends DaoExecutor {
		...
		private String getSqlDelete(String psTable, PS_TYPE dstType, long psDate) {
			...
			sql.append("delete from " + destTable + " where " + VoApiDB.PS_DATE.getName() + "="
					+ dstType.getHstimeStart(psDate));
