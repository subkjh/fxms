package fxms.bas.fxo.service.noti.thread;
 ...
 *
 */
public class NotiPeerFxThread extends QueueFxThread<FxEvent> {
	...
	public NotiPeerFxThread(String fxServiceId, FxService service, NotiFilter filter) {
		super("::" + fxServiceId, FxCfg.ALIVE_SIGNAL_CYCLE);
