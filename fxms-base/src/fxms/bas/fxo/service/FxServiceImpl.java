		...
		for (FxActor e : getFxActorArray()) {
			try {
				...
				if (e instanceof NotiReceiver) {
					...
					// logger.debug("receiver={}, noti={}", notiReceiver.getName(), noti);
					notiReceiver.onNotify(noti);
					// logger.trace("receiver={}, noti={} ok", notiReceiver.getName(), noti);
				}
