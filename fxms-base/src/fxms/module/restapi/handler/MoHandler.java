...
import fxms.bas.dao.MoHandlerDao;
import fxms.bas.dbo.FX_CF_MODEL;
import fxms.bas.dbo.mo.FX_CF_INLO;
import fxms.bas.dbo.mo.FX_CF_INLO_MEM;
...
import fxms.module.restapi.handler.func.MoUpdate;
...
public class MoHandler extends CommHandler {
	...
	public Object addInlo(SessionVo session, Map<String, Object> parameters) throws Exception {
		...
		try {
			...
			tran.insert(item);
			tran.deleteOfClass(FX_CF_INLO_MEM.class, FxDaoExecutor.makePara("memInloNo", item.getInloNo()));
	...
	public Object deleteMo(SessionVo session, Map<String, Object> parameters) throws Exception {
		...
		try {
			...
			mo = MoApi.getApi().getMo(moNo.longValue());
			...
			MoApi.getApi().deleteMo(mo, mo.getChgUserNo(), "user-delete");
	...
	public Object getMoList(SessionVo session, Map<String, Object> parameters) throws Exception {
		...
		if (parameters.get("moClass") == null) {
			...
			return MoApi.getApi().getMoList(classOfMo, parameters);
		}
	}
