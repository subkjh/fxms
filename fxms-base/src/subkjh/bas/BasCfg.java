...
public class BasCfg {
	...
	public static final String PARA_PROJECT = "PROJECT";
	...
	public static String getHome() {
		if (home == null)
			home = System.getProperty("FXMS_HOME");
		if (home == null)
			home = System.getenv("FXMS_HOME");
		home = home == null ? "." : home;
		return home;
	}
	 ...
	 * @return
	 */
	public static int getInt(Map<String, Object> para, String name, int defaultValue) {
		if (para == null)
			return defaultValue;
	 ...
	 */
	public static String getPathMo() {
		return getFile(getHomeDeploy(), "mo");
	}
	...
	public LOG_LEVEL getLogLevel() {
		return LOG_LEVEL.getLevel(getString("LOG-LEVEL", "trace"));
	}

	public int getLogMaxFile() {
		return getInt("LOG-MAX-FILE-SIZE", 10);
	}
	...
	public String getProject() {
		return getString(PARA_PROJECT, null);
	}
	...
	public boolean isEnable(String name, boolean defaultValue) {
		if (para == null)
			return defaultValue;
	...
	public boolean isLogPrintConsole() {
		return isEnable("LOG-PRINT-CONSOLE", false);
	}
