 ...
 * @author subkjh
 */
public class Column extends SoDo {
	...
	public static void main(String[] args) {
		System.out.println(SoDo.getDaoName("ColumnName"));
		System.out.println(SoDo.getDaoName("columnName"));
		System.out.println(SoDo.getDaoName("column-Name"));
		System.out.println(SoDo.getDaoName("column_Name"));
	...
	public Column(String name, String dataType, int length, int scale, boolean nullable) {
		setName(name);
	...
	public String getDataDefaultUse() {
		return dataDefault == null ? "" : dataDefault.replaceAll("'", "\"");
	}
	...
	public String getFieldName() {
		...
		if (fieldName == null) {
			fieldName = SoDo.getJavaFieldName(name, false);
		}
	...
	public boolean isMatch(String name) {
		return this.name.equals(getDaoName(name));
	}
	...
	public String toString() {
		return getName() + "|" + getDataType2Define();
	}
