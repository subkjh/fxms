...
@FxIndex(name = "FX_BR_ITEM_DEF_ATTR__FK1", type = INDEX_TYPE.FK, columns = {
		"BR_ITEM_NAME" }, fkTable = "FX_BR_ITEM_DEF", fkColumn = "BR_ITEM_NAME")
public class FX_BR_ITEM_DEF_ATTR {
