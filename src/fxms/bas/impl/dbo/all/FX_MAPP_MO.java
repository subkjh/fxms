...
@FxTable(name = "FX_MAPP_MO", comment = "매핑관리대상테이블")
@FxIndex(name = "FX_MAPP_MO__PK", type = INDEX_TYPE.PK, columns = {"MNG_DIV", "MAPP_DATA"})
@FxIndex(name = "FX_MAPP_MO__KEY1", type = INDEX_TYPE.KEY, columns = {"MNG_DIV", "MAPP_ID"})
public class FX_MAPP_MO implements Serializable {
