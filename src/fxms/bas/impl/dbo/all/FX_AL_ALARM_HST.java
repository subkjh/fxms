...
@FxIndex(name = "FX_AL_HST__KEY1", type = INDEX_TYPE.KEY, columns = {"MO_NO"})
@FxIndex(name = "FX_AL_HST__KEY2", type = INDEX_TYPE.KEY, columns = {"ALCD_NO"})
@FxIndex(name = "FX_AL_HST__KEY3", type = INDEX_TYPE.KEY, columns = {"OCCUR_DTM"})
@FxIndex(name = "FX_AL_HST__KEY4", type = INDEX_TYPE.KEY, columns = {"ALARM_KEY"})
@FxIndex(name = "FX_AL_HST__KEY5", type = INDEX_TYPE.KEY, columns = {"MO_CLASS"})
@FxIndex(name = "FX_AL_HST__FK1", type = INDEX_TYPE.FK, columns = {"ALCD_NO"}, fkTable = "FX_AL_CD", fkColumn = "ALCD_NO")
public class FX_AL_ALARM_HST  {
