...
@FxColumn(name = "STAT_DTM", size = 1024, nullable = true, comment = "통계시간")
private String statDtm;
...
*@param statDtm 통계시간
*/
public void setStatDtm(String statDtm) {
	this.statDtm = statDtm;
}
/**
* NULL값
* @return NULL값
