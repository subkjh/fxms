...
@FxIndex(name = "FX_PS_STAT_CRE__FK1", type = INDEX_TYPE.FK, columns = {"PS_TBL"}, fkTable = "FX_PS_ITEM", fkColumn = "PS_TBL")
public class FX_PS_STAT_CRE implements Serializable {
