...
@FxIndex(name = "FX_AL_ALARM_CUR__FK1", type = INDEX_TYPE.FK, columns = {
		"MO_NO" }, fkTable = "FX_MO", fkColumn = "MO_NO")
@FxIndex(name = "FX_AL_ALARM_CUR__FK2", type = INDEX_TYPE.FK, columns = {
		"ALARM_NO" }, fkTable = "FX_AL_ALARM_HST", fkColumn = "ALARM_NO")
public class FX_AL_ALARM_CUR implements Serializable {
