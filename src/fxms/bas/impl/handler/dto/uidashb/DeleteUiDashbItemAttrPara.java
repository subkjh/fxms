...
@FxIndex(name = "FX_UI_DASHB_ITEM_ATTR__PK", type = INDEX_TYPE.PK, columns = {"DASHB_NO", "UI_NO"})
public class DeleteUiDashbItemAttrPara {

	public DeleteUiDashbItemAttrPara() {
	}
