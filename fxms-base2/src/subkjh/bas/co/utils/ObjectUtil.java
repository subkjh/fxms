...
public class ObjectUtil {
	...
	public static <T> Class<T> getClass4Use(Class<T> classOf) {
	...
	public static <T> T makeObject4Use(Class<T> classOfT) throws Exception {
		...
		try {
			...
			Logger.logger.fail("Not Define CLASS:{}. Check {}", classOfT.getName(), FxCfg.getHomeDeployConf("classes.xml"));
			throw e;
		}
	}
	...
	public static void setMethod(Object target, Method method, Object value) throws Exception {
		...
		if (value == null) {
			...
			method.invoke(target, (int) (value instanceof Number ? ((Number) value).intValue() : Integer.parseInt(str)));
		} else if (type == Long.TYPE || type == Long.class) {
			method.invoke(target, (long) (value instanceof Number ? ((Number) value).longValue() : Long.parseLong(str)));
		} else if (type == Double.TYPE || type == Double.class) {
			method.invoke(target, (double) (value instanceof Number ? ((Number) value).doubleValue() : Double.parseDouble(str)));
		} else if (type == Short.TYPE || type == Short.class) {
			method.invoke(target, (short) (value instanceof Number ? ((Number) value).shortValue() : Short.parseShort(str)));
		} else if (type == Float.TYPE || type == Float.class) {
			method.invoke(target, (float) (value instanceof Number ? ((Number) value).floatValue() : Float.parseFloat(str)));
		} else if (type == Byte.TYPE || type == Byte.class) {
			method.invoke(target, (byte) (value instanceof Number ? ((Number) value).byteValue() : Byte.parseByte(str)));
