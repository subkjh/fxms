...
public class MsCall {
	...
	public boolean call(String host, int port, String method, String paraStr[]) {
		...
		try {
			FxMS ms = (FxMS) Naming.lookup("rmi://" + host + ":" + port + "/" + MS.name);
	...
	private boolean call(FxMS service, String method, String paraStr[], boolean ignoreCase) throws Exception {
		boolean isMethod;
