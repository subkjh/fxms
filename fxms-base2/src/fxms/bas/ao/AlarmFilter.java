...
public abstract class AlarmFilter extends FxActorImpl implements Serializable {
	 ...
	 *            생성된 경보
	 */
	public abstract void filter(OccurAlarm alarm);

	public abstract void filter(ClearAlarm alarm);
	 ...
	 */
	public abstract OccurAlarm filter(AlarmEvent event, OccurAlarm alarm, Mo mo);
}
