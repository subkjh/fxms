...
import fxms.bas.po.filter.ValuePeekerMap;
...
public class VoSubNotifier extends QueueFxThread<VoList> {
	...
	private VoSubNotifier() {
		setName(VoSubNotifier.class.getSimpleName());
	...
	public void setPeeker(long moNo, String moInstance, String psCode, ValuePeeker peeker, boolean add) {
		Logger.logger.info("moNo={}, moInstance={}, psCode={}, peeker={}, add={}", moNo, moInstance, psCode, peeker, add);
		if (add) {
