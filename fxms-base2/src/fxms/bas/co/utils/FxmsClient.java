...
import fxms.bas.co.exp.ReloginException;
...
public class FxmsClient {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> testRetList(String uri, String method, Map<String, Object> parameters) throws Exception {
