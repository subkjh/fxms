...
//		System.out.println(tree.getDataList2Level(13));
	...
	private Map<String, TreeItem<DATA>> dataMap = new HashMap<String, TreeItem<DATA>>();
	private List<TreeItem<DATA>> rootList = new ArrayList<TreeItem<DATA>>();

	private List<TreeItem<DATA>> allList = new ArrayList<TreeItem<DATA>>();

	public void addChild(String parentId, String childId, DATA data) {

		TreeItem<DATA> child = new TreeItem<DATA>(childId, data);

		TreeItem<DATA> parent = getData(parentId);
		if (parent != null) {
