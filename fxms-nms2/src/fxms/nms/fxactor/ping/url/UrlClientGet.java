package fxms.nms.fxactor.ping.url;
...
//		site = "http://localhost:8080/fxms-rest-api/bio/fxapi/callProcess";
		String site = "http://192.168.0.199:9080/rpc?target=swms&method=dev.device.get_wan_tab&body=";

		Gson son = new Gson();
//		{"ip":"211.58.70.233","vendor":"mmc-ap","dev_mac":"085DDD9AAA55","dev_model":"Giga AP(머큐리 RUSH-337AC)","net_type":"LanE","vail":false,"limit":20,"page":1,"method":"dev.device.get_wan_tab","no_session":false}:
