...
import fxms.nms.fxactor.snmpping.SnmpPingFxActor;
...
public class SnmpPoller extends Poller<NeMo> {
	...
	@Override
	protected void pollingGroup(long pollMsdate, List<PollingMo> moList, PollCallback callback) throws PollingTimeoutException,
			Exception {
	}
