...
import fxms.bas.po.counter.ValueCounter;
import fxms.bas.po.counter.ValueCounter32;
import fxms.bas.po.counter.ValueCounter64;
import fxms.bas.po.counter.exception.FirstCounterNotFoundException;
import fxms.bas.po.counter.exception.ResetCounterException;
...
public abstract class SnmpUtil {
	 ...
	 */
	public abstract List<OidValue> snmpbulk(MoSnmppable snmpNode, int nonRepeaters, int maxRepetitions, String... oidArray)
	 ...
	 * @throws Exception
	 */
	public List<OidValue> snmpCheckCounter(MoSnmppable node, List<OidValue> ovList, String tag) throws SnmpTimeoutException,
			Exception {
	 ...
	 * @throws Exception
	 */
	public OidValue snmpCheckCounter(MoSnmppable node, OidValue oid, String tag) throws SnmpTimeoutException, Exception {
	 ...
	 * @throws SnmpErrorException
	 */
	public abstract int snmpget(MoSnmppable snmpNode, SnmpListener snmpListener, String... oidArr) throws SnmpErrorException;
	 ...
	 * @throws SnmpErrorException
	 */
	public List<OidValue> snmpget(MoSnmppable snmpNode, String... _oidArray) throws SnmpTimeoutException, SnmpNotFoundOidException,
			SnmpErrorException {
	 ...
	 * @throws SnmpErrorException
	 */
	public abstract List<OidValue> snmpgetnext(MoSnmppable snmpNode, String... oidArray) throws SnmpTimeoutException,
	 ...
	 * @throws SnmpErrorException
	 */
	public abstract List<OidValue> snmpset(MoSnmppable snmpNode, OidValue... oidValueArray) throws SnmpTimeoutException,
			SnmpNotFoundOidException, SnmpErrorException;
	 ...
	 * @throws SnmpErrorException
	 */
	public abstract List<OidValue> snmpwalk(MoSnmppable snmpNode, String oid) throws SnmpTimeoutException,
			SnmpNotFoundOidException, SnmpErrorException;
	 ...
	 * @throws SnmpErrorException
	 */
	public abstract List<OidValue>[] snmpwalk(MoSnmppable snmpNode, String... oidArr) throws SnmpTimeoutException,
			SnmpNotFoundOidException, SnmpErrorException;
	 ...
	 * @throws SnmpErrorException
	 */
	protected abstract List<OidValue> doSnmpget(MoSnmppable snmpNode, String... oidArr) throws SnmpTimeoutException,
			SnmpNotFoundOidException, SnmpErrorException;
