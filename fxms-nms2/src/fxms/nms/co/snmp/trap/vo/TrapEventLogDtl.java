 ...
 * 
 */
public class TrapEventLogDtl implements Serializable {
	...
	public TrapEventLogDtl() {

	}

	public TrapEventLogDtl(String ipAddrRecv, long seqnoRecv, String varIndex, String varOid, String varOidName, String varValue,
