 ...
 * 
 */
public class TrapLog extends FxEventImpl {
	...
	private List<TrapLogDetail> details;
	 ...
	 */
	@Deprecated
	public void addDetail(TrapLogDetail detail) {
		if (details == null)
			details = new ArrayList<TrapLogDetail>();
		details.add(detail);
	}

	public List<TrapLogDetail> getDetails() {
		return details;
	}
	...
	public String getFileLine() {
		...
		// s.substring(12) + " " + getLogMsg() + ","
		// + getAlarmCode() + "|" + getAlarmLevel();
		// } else {
		// return getHstimeRecv() + ":" + getLogMsg() + "," + getAlarmCode() +
		// "|" + getAlarmLevel();
		// }
	...
	public void setDetails(List<TrapLogDetail> details) {
