 ...
 *
 */
public class TrapFileMngCron extends Crontab {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1484877320303241319L;

	@Override
	public void cron() throws Exception {
		File folder = new File(TrapApi.getApi().getTrapLogFile());
		...
		int count;
		int ret;
		int trapLogFileTermDays = getFxPara().getInt("trapLogFileKeepDays", 0);
