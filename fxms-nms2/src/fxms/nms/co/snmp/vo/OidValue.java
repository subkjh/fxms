...
public class OidValue implements Serializable {
	...
	public static void main(String[] args) {
		...
		byte bytes[] = new byte[] { (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
				(byte) 0xff };
	...
	public OidValue(String oid, byte valueType, byte valueBytes[]) {
		this.oid = oid;
		this.valueType = Type.getOidType(valueType);
	...
	public OidValue(String oid, Type type, String valueString, byte bytes[]) {
		this.oid = oid;
		this.valueType = type;
	...
	public String getHstimeDateAndTime() {
		...
		return String.format("%04d%02d%02d%02d%02d%02d", year, valueBytes[2], valueBytes[3], valueBytes[4], valueBytes[5],
				valueBytes[6]);
	...
	public String getIpAddress() {
		...
		return String.format("%d.%d.%d.%d", valueBytes[0] & 0xff, valueBytes[1] & 0xff, valueBytes[2] & 0xff, valueBytes[3] & 0xff);
	}
	...
	public String toString() {
		return oid + " " + valueType + " " + valueString;
	}
}
