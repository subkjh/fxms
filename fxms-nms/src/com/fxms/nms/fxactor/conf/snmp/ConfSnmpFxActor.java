...
import com.fxms.nms.fxactor.NeConfigActor;
import com.fxms.nms.mo.property.MoSnmppable;
import com.fxms.nms.snmp.FilterValidChecker;
...
public abstract class ConfSnmpFxActor extends FxActorImpl implements NeConfigActor {
	...
	protected OidValue[] snmpget(MoSnmppable node, String... oidArr)
	...
	protected OidValue[] snmpnext(MoSnmppable node, String... oidArr)
			throws SnmpTimeoutException, SnmpErrorException, SnmpNotFoundOidException, Exception {
	...
	protected List<OidValue>[] snmpwalk(MoSnmppable node, String... oidArr)
			throws SnmpTimeoutException, SnmpErrorException, SnmpNotFoundOidException, Exception {
	...
	protected List<OidValue> snmpwalk(MoSnmppable node, String oid)
			throws SnmpTimeoutException, SnmpErrorException, SnmpNotFoundOidException, Exception {
